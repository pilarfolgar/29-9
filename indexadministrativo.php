...
<script>
Swal.fire({
  icon: '<?php echo ($_SESSION['error_docente'] === "docente_existente") ? "error" : "error"; ?>',
...
Swal.fire({
  icon: 'success',
  title: '¡Éxito!',
  text: 'Horario registrado con éxito',
  timer: 2500,
...
<?php if (isset($_SESSION['error_horario']) && $_SESSION['error_horario'] === 'asignatura_inexistente'): ?>
<script>
Swal.fire({
  icon: 'error',
...
<?php if (isset($_SESSION['error_horario']) && $_SESSION['error_horario'] === 'duplicado'): ?>
<script>
Swal.fire({
  icon: 'warning',
  title: 'Horario duplicado',
  text: 'Ya existe un horario registrado con estos datos'
});
</script>
<?php unset($_SESSION['error_horario']); endif; ?>
